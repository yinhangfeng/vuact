---
name: vuact
description: Vuact 最佳实践与集成指南，提供在 Vue3 项目中无缝集成 React 生态的完整方案，包括配置 Vite/pnpm alias、r2v/v2r 组件互转、slots/事件/上下文互通、setup-scheduler/setup-renderer 初始化、以及完整的示例参考与兼容性说明。
---
...
- Vue 侧可以通过 slots 给 React 组件传递 children 和 element props
