...
const benchs: Record<string, () => void> = {
  'keyed/react-hooks': () => {
    import('./js-framework-benchmark/frameworks/keyed/react-hooks/src/main.jsx');
  },
  'keyed/react-classes': () => {
    import('./js-framework-benchmark/frameworks/keyed/react-classes/src/main.jsx');
  },
  'keyed/react-hooks-use-transition': () => {
    import('./js-framework-benchmark/frameworks/keyed/react-hooks-use-transition/src/main.jsx');
  },
  'keyed/react-redux': () => {
    import('./js-framework-benchmark/frameworks/keyed/react-redux/src/main.jsx');
  },
  'keyed/react-redux-hooks': () => {
    import('./js-framework-benchmark/frameworks/keyed/react-redux-hooks/src/main.jsx');
  },
  'keyed/react-redux-hooks-immutable': () => {
    import('./js-framework-benchmark/frameworks/keyed/react-redux-hooks-immutable/src/main.jsx');
  },
  'keyed/react-mobx': () => {
