...
describe('ReactES6Class', () => {
  ...
  it('setState through an event handler', async () => {
    class Foo extends React.Component {
      constructor(props) {
        super(props);
        this.state = {bar: props.initialValue};
  ...
  it('should not implicitly bind event handlers', async () => {
    class Foo extends React.Component {
      constructor(props) {
        super(props);
        this.state = {bar: props.initialValue};
  ...
  it('will call all the normal life cycle methods', async () => {
    let lifeCycles = [];
    class Foo extends React.Component {
      constructor() {
        super();
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should throw AND warn when trying to access classic APIs', () => {
    const ref = React.createRef();
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'supports string refs', () => {
    class Foo extends React.Component {
      render() {
