...
describe('ReactLazy', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'multiple lazy components', async () => {
    function Foo() {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'does not support arbitrary promises, only module objects', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'throws if promise rejects', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'mount and reorder', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'resolves defaultProps without breaking bailout due to unchanged props and state, #17151', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'sets defaultProps for modern lifecycles', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'throws with a useful error when wrapping invalid type with lazy()', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'throws with a useful error when wrapping lazy() multiple times', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'respects propTypes on function component without defaultProps', async () => {
    function Add(props) {
      return props.inner + props.outer;
    }
    Add.propTypes = {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'respects propTypes on class component with defaultProps', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should error with a component stack naming the resolved component', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should error with a component stack containing Lazy if unresolved', () => {
    let componentStackMessage;
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'mount and reorder lazy types', async () => {
    class Child extends React.Component {
      componentWillUnmount() {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'mount and reorder lazy types (legacy mode)', async () => {
    class Child extends React.Component {
      componentDidMount() {
        Scheduler.unstable_yieldValue('Did mount: ' + this.props.label);
      }
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'mount and reorder lazy elements', async () => {
    class Child extends React.Component {
      componentDidMount() {
        Scheduler.unstable_yieldValue('Did mount: ' + this.props.label);
      }
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'mount and reorder lazy elements (legacy mode)', async () => {
    class Child extends React.Component {
      componentDidMount() {
        Scheduler.unstable_yieldValue('Did mount: ' + this.props.label);
      }
