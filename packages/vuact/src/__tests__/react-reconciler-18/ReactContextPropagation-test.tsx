...
describe('ReactLazyContextPropagation', () => {
  ...
  test.skipIf(__VUACT_SKIP_TEST__, "context consumer bails out if context hasn't changed", async () => {
    const root = ReactNoop.createRoot();
  ...
  // @gate enableCache
  test.skipIf(__VUACT_SKIP_TEST__, 'context is propagated across retries', async () => {
    const root = ReactNoop.createRoot();
  ...
  // @gate enableCache
  test.skipIf(__VUACT_SKIP_TEST__, 'multiple contexts are propagated across retries', async () => {
  ...
  // @gate enableCache
  test.skipIf(__VUACT_SKIP_TEST__, 'context is propagated across retries (legacy)', async () => {
  ...
  // @gate www
  test.skipIf(__VUACT_SKIP_TEST__, 'context is propagated through offscreen trees', async () => {
  ...
  // @gate www
  test.skipIf(__VUACT_SKIP_TEST__, 'multiple contexts are propagated across through offscreen trees', async () => {
    // Same as previous test, but with multiple context providers
    const LegacyHidden = React.unstable_LegacyHidden;
  ...
  // @gate enableCache
  test.skipIf(__VUACT_SKIP_TEST__, 'nested bailouts across retries', async () => {
    // Lazy context propagation will stop propagating when it hits the first
    // match. If we bail out again inside that tree, we must resume propagating.
  ...
  // @gate www
  test.skipIf(__VUACT_SKIP_TEST__, 'nested bailouts through offscreen trees', async () => {
    // Lazy context propagation will stop propagating when it hits the first
    // match. If we bail out again inside that tree, we must resume propagating.
