...
describe('ReactBlockingMode', () => {
  ...
  // TODO vuact3 不支持 react-cache
  it.skipIf(__VUACT_SKIP_TEST__, 'uses proper Suspense semantics, not legacy ones', async () => {
    const root = ReactNoop.createRoot();
    root.render(
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'flushSync does not flush batched work', () => {
