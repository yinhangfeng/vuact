...
describe('ReactIncrementalSideEffects', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'can update child nodes of a host instance', () => {
    function Bar(props) {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'can update child nodes of a fragment', function() {
    function Bar(props) {
      return <span>{props.text}</span>;
    }
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'can update child nodes rendering into text nodes', function() {
    function Bar(props) {
      return props.text;
    }
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'can delete a child when it unmounts inside a portal', () => {
    function Bar(props) {
      return <span prop={props.children} />;
    }
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'can delete a child when it unmounts with a portal', () => {
    function Bar(props) {
      return <span prop={props.children} />;
    }
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'does not update child nodes if a flush is aborted', () => {
    function Bar(props) {
  ...
  // @gate www
  it.skipIf(__VUACT_SKIP_TEST2__, 'preserves a previously rendered node when deprioritized', () => {
  ...
  // @gate www
  it.skipIf(__VUACT_SKIP_TEST2__, 'can reuse side-effects after being preempted', () => {
    function Bar(props) {
      Scheduler.unstable_yieldValue('Bar');
      return <span prop={props.children} />;
    }
  ...
  // @gate www
  it.skipIf(__VUACT_SKIP_TEST2__, 'can reuse side-effects after being preempted, if shouldComponentUpdate is false', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'can update a completed tree before it has a chance to commit', () => {
    function Foo(props) {
      Scheduler.unstable_yieldValue('Foo');
  ...
  // @gate www
  it.skipIf(__VUACT_SKIP_TEST2__, 'updates a child even though the old props is empty', () => {
    function Foo(props) {
      return (
        <LegacyHiddenDiv mode="hidden">
          <span prop={1} />
  ...
  // @gate www
  it.skipIf(__VUACT_SKIP_TEST2__, 'deprioritizes setStates that happens within a deprioritized tree', () => {
    const barInstances = [];
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'calls callback after update is flushed', () => {
    let instance;
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'calls componentWillUnmount after a deletion, even if nested', () => {
    const ops = [];
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'calls componentDidMount/Update after insertion/update', () => {
    let ops = [];
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'invokes ref callbacks after insertion/update/unmount', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'supports string refs', () => {
