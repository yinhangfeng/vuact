...
describe('ReactHooksWithNoopRenderer', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'resumes after an interruption', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'throws inside class components', () => {
  ...
  if (!flags.disableModulePatternComponents) {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'throws when called outside the render phase', () => {
    expect(() => {
  ...
  describe('updates during the render phase', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'throws after too many iterations', () => {
      function Counter({row: newRow}) {
        const [count, setCount] = useState(0);
        setCount(count + 1);
        Scheduler.unstable_yieldValue('Render: ' + count);
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'uses reducer passed at time of render, not time of dispatch', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'discards render phase updates if something suspends', async () => {
      const thenable = {then() {}};
      function Foo({signal}) {
        return (
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'discards render phase updates if something suspends, but not other updates in the same component', async () => {
      const thenable = {then() {}};
      function Foo({signal}) {
        return (
          <Suspense fallback="Loading...">
  ...
  describe('useReducer', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'handles dispatches with mixed priorities', () => {
      const INCREMENT = 'INCREMENT';
  ...
  describe('useEffect', () => {
    it.skipIf(__VUACT_SKIP_TEST__, 'simple mount and update', () => {
      function Counter(props) {
        useEffect(() => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'flushes passive effects even with sibling deletions', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'flushes passive effects even if siblings schedule an update', () => {
      function PassiveEffect(props) {
        useEffect(() => {
          Scheduler.unstable_yieldValue('Passive effect');
        });
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'flushes passive effects even if siblings schedule a new root', () => {
      function PassiveEffect(props) {
        useEffect(() => {
          Scheduler.unstable_yieldValue('Passive effect');
        }, []);
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'defers passive effect destroy functions during unmount', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'does not warn about state updates for unmounted components with pending passive unmounts', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'does not warn about state updates for unmounted components with pending passive unmounts for alternates', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'does not warn about state updates for unmounted components with no pending passive unmounts', () => {
      let completePendingRequest = null;
      function Component() {
        Scheduler.unstable_yieldValue('Component');
        const [didLoad, setDidLoad] = React.useState(false);
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'does not warn if there are pending passive unmount effects but not for the current fiber', () => {
      let completePendingRequest = null;
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'does not warn if there are updates after pending passive unmount effects have been flushed', () => {
      let updaterFunction;
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'does not show a warning when a component updates its own state from within passive unmount function', () => {
      function Component() {
        Scheduler.unstable_yieldValue('Component');
        const [didLoad, setDidLoad] = React.useState(false);
        React.useEffect(() => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'does not show a warning when a component updates a child state from within passive unmount function', () => {
      function Parent() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'does not show a warning when a component updates a parents state from within passive unmount function', () => {
      function Parent() {
        const [state, setState] = React.useState(false);
        Scheduler.unstable_yieldValue('Parent');
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'updates have async priority', () => {
      function Counter(props) {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'updates have async priority even if effects are flushed early', () => {
      function Counter(props) {
        const [count, updateCount] = useState('(empty)');
        useEffect(() => {
          Scheduler.unstable_yieldValue(`Schedule update [${props.count}]`);
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'does not flush non-discrete passive effects when flushing sync', () => {
      let _updateCount;
      function Counter(props) {
        const [count, updateCount] = useState(0);
        _updateCount = updateCount;
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'flushSync is not allowed', () => {
      function Counter(props) {
        const [count, updateCount] = useState('(empty)');
        useEffect(() => {
          Scheduler.unstable_yieldValue(`Schedule update [${props.count}]`);
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'unmounts previous effect', () => {
      function Counter(props) {
        useEffect(() => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'unmounts on deletion', () => {
      function Counter(props) {
        useEffect(() => {
          Scheduler.unstable_yieldValue(`Did create [${props.count}]`);
          return () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'unmounts on deletion after skipped effect', () => {
      function Counter(props) {
        useEffect(() => {
          Scheduler.unstable_yieldValue(`Did create [${props.count}]`);
          return () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'always fires effects if no dependencies are provided', () => {
      function effect() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'skips effect if inputs have not changed', () => {
      function Counter(props) {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'multiple effects', () => {
      function Counter(props) {
        useEffect(() => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'unmounts all previous effects before creating any new ones', () => {
      function Counter(props) {
        useEffect(() => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'unmounts all previous effects between siblings before creating any new ones', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'handles errors in create on mount', () => {
      function Counter(props) {
        useEffect(() => {
          Scheduler.unstable_yieldValue(`Mount A [${props.count}]`);
          return () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'handles errors in create on update', () => {
      function Counter(props) {
        useEffect(() => {
          Scheduler.unstable_yieldValue(`Mount A [${props.count}]`);
          return () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'handles errors in destroy on update', () => {
      function Counter(props) {
        useEffect(() => {
          Scheduler.unstable_yieldValue(`Mount A [${props.count}]`);
          return () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'works with memo', () => {
    ...
    describe('errors thrown in passive destroy function within unmounted trees', () => {
      ...
      it('should call getDerivedStateFromError in the nearest still-mounted boundary', () => {
        ...
        // TODO vuact3 ErrorBoundary componentDidCatch 调用时机
        if (!__VUACT_SKIP_TEST__) {
          expect(Scheduler).toHaveYielded([
            'ErrorBoundary render success',
            'BrokenUseEffectCleanup useEffect destroy',
    ...
    it('calls passive effect destroy functions for memoized components', () => {
      ...
      // TODO vuact2 旧组件 destroy 新组件 render 顺序与 react 不同
      if (!__VUACT_SKIP_TEST__) {
        expect(Scheduler).toHaveYielded([
          'render',
          'layout destroy',
  ...
  describe('useInsertionEffect', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'fires insertion effects before layout effects', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'force flushes passive effects before firing new insertion effects', () => {
      let committedText = '(empty)';
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'fires all insertion effects (interleaved) before firing any layout effects', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'warns when setState is called from insertion effect setup', () => {
      function App(props) {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'warns when setState is called from insertion effect cleanup', () => {
      function App(props) {
        const [, setX] = useState(0);
        useInsertionEffect(() => {
          if (props.throw) {
  ...
  describe('useLayoutEffect', () => {
    it.skipIf(__VUACT_SKIP_TEST__, 'fires layout effects after the host has been mutated', () => {
      function getCommittedText() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'force flushes passive effects before firing new layout effects', () => {
      let committedText = '(empty)';
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'useTransition', () => {
    it.skipIf(__VUACT_SKIP_TEST__, 'delays showing loading state until after timeout', async () => {
      let transition;
      function App() {
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'useDeferredValue', () => {
    it.skipIf(__VUACT_SKIP_TEST__, 'defers text value', async () => {
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'progressive enhancement (not supported)', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'useReducer applies potential no-op changes if made relevant by other updates in the batch', () => {
    let setDisabled;
    let increment;
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'regression: SuspenseList causes unmounts to be dropped on deletion', async () => {
    function Row({label}) {
      useEffect(() => {
        Scheduler.unstable_yieldValue('Mount ' + label);
        return () => {
