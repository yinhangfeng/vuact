...
describe.skip('ReactInterleavedUpdates', () => {
  beforeEach(() => {
    jest.resetModules();
  ...
  test.skipIf(__VUACT_SKIP_TEST2__, 'update during an interleaved event is not processed during the current render', async () => {
    const updaters = [];
  ...
  test.skipIf(__VUACT_SKIP_TEST2__, 'low priority update during an interleaved event is not processed during the current render', async () => {
  ...
  test.skipIf(__VUACT_SKIP_TEST2__, 'regression for #24350: does not add to main update queue until interleaved update queue has been cleared', async () => {
    let setStep;
    function App() {
