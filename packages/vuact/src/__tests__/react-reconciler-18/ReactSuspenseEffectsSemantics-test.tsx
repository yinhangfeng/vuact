...
describe.skip('ReactSuspenseEffectsSemantics', () => {
  beforeEach(() => {
    jest.resetModules();
  ...
  describe.skipIf(__VUACT_SKIP_TEST2__, 'when a component suspends during initial mount', () => {
    // @gate enableCache
  ...
  describe('layout effects within a tree that re-suspends in an update', () => {
    // @gate enableCache
    it.skipIf(__VUACT_SKIP_TEST2__, 'should not be destroyed or recreated in legacy roots', async () => {
      function App({children = null}) {
        Scheduler.unstable_yieldValue('App render');
        React.useLayoutEffect(() => {
          Scheduler.unstable_yieldValue('App create layout');
    ...
    // @gate enableCache
    it.skipIf(__VUACT_SKIP_TEST2__, 'should be destroyed and recreated for function components', async () => {
      function App({children = null}) {
        Scheduler.unstable_yieldValue('App render');
        React.useLayoutEffect(() => {
          Scheduler.unstable_yieldValue('App create layout');
    ...
    // @gate enableSuspenseLayoutEffectSemantics
    // @gate enableCache
    it.skipIf(__VUACT_SKIP_TEST2__, 'should be destroyed and recreated for class components', async () => {
      class ClassText extends React.Component {
        componentDidMount() {
          const {text} = this.props;
          Scheduler.unstable_yieldValue(`ClassText:${text} componentDidMount`);
    ...
    // @gate enableSuspenseLayoutEffectSemantics
    // @gate enableCache
    it.skipIf(__VUACT_SKIP_TEST2__, 'should be destroyed and recreated when nested below host components', async () => {
      function App({children = null}) {
        Scheduler.unstable_yieldValue('App render');
        React.useLayoutEffect(() => {
          Scheduler.unstable_yieldValue('App create layout');
    ...
    // @gate enableSuspenseLayoutEffectSemantics
    // @gate enableCache
    it.skipIf(__VUACT_SKIP_TEST2__, 'should be destroyed and recreated even if there is a bailout because of memoization', async () => {
    ...
    // @gate enableSuspenseLayoutEffectSemantics
    // @gate enableCache
    it.skipIf(__VUACT_SKIP_TEST2__, 'should respect nested suspense boundaries', async () => {
    ...
    // @gate enableSuspenseLayoutEffectSemantics
    // @gate enableCache
    it.skipIf(__VUACT_SKIP_TEST2__, 'should show nested host nodes if multiple boundaries resolve at the same time', async () => {
      function App({innerChildren = null, outerChildren = null}) {
        return (
          <Suspense fallback={<Text text="OuterFallback" />}>
            <Text text="Outer" />
    ...
    // @gate enableSuspenseLayoutEffectSemantics
    // @gate enableCache
    it.skipIf(__VUACT_SKIP_TEST2__, 'should be cleaned up inside of a fallback that suspends', async () => {
    ...
    // @gate enableSuspenseLayoutEffectSemantics
    // @gate enableCache
    it.skipIf(__VUACT_SKIP_TEST2__, 'should be cleaned up inside of a fallback that suspends (alternate)', async () => {
      function App({fallbackChildren = null, outerChildren = null}) {
        return (
          <>
            <Suspense
    ...
    // @gate enableSuspenseLayoutEffectSemantics
    // @gate enableCache
    it.skipIf(__VUACT_SKIP_TEST2__, 'should be cleaned up deeper inside of a subtree that suspends', async () => {
    ...
    describe('that throw errors', () => {
      // @gate enableSuspenseLayoutEffectSemantics
      // @gate enableCache
      it.skipIf(__VUACT_SKIP_TEST2__, 'are properly handled for componentDidMount', async () => {
      ...
      // @gate enableSuspenseLayoutEffectSemantics
      // @gate enableCache
      it.skipIf(__VUACT_SKIP_TEST2__, 'are properly handled for componentWillUnmount', async () => {
      ...
      it.skipIf(__VUACT_SKIP_TEST2__, 'are properly handled for layout effect creation', async () => {
      ...
      // @gate enableCache
      // @gate replayFailedUnitOfWorkWithInvokeGuardedCallback
      it.skipIf(__VUACT_SKIP_TEST2__, 'are properly handled for layout effect destruction', async () => {
    ...
    // @gate enableSuspenseLayoutEffectSemantics
    // @gate enableCache
    it.skipIf(__VUACT_SKIP_TEST2__, 'should be only destroy layout effects once if a tree suspends in multiple places', async () => {
      class ClassText extends React.Component {
        componentDidMount() {
          const {text} = this.props;
          Scheduler.unstable_yieldValue(`ClassText:${text} componentDidMount`);
    ...
    // @gate enableSuspenseLayoutEffectSemantics
    // @gate enableCache
    it.skipIf(__VUACT_SKIP_TEST2__, 'should be only destroy layout effects once if a component suspends multiple times', async () => {
      class ClassText extends React.Component {
        componentDidMount() {
          const {text} = this.props;
          Scheduler.unstable_yieldValue(`ClassText:${text} componentDidMount`);
  ...
  describe.skipIf(__VUACT_SKIP_TEST2__, 'refs within a tree that re-suspends in an update', () => {
