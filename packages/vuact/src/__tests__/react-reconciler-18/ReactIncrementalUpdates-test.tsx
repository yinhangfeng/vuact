...
describe.skip('ReactIncrementalUpdates', () => {
  beforeEach(() => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'applies updates in order of priority', () => {
    let state;
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'applies updates with equal priority in insertion order', () => {
    let state;
    class Foo extends React.Component {
      state = {};
      componentDidMount() {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'only drops updates with equal or lesser priority when replaceState is called', () => {
    let instance;
    class Foo extends React.Component {
      state = {};
      componentDidMount() {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'can abort an update, schedule additional updates, and resume', () => {
    let instance;
    class Foo extends React.Component {
      state = {};
      render() {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'can abort an update, schedule a replaceState, and resume', () => {
    let instance;
    class Foo extends React.Component {
      state = {};
      render() {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'passes accumulation of previous updates to replaceState updater function', () => {
    let instance;
    class Foo extends React.Component {
      state = {};
      render() {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'does not call callbacks that are scheduled by another callback until a later commit', () => {
    class Foo extends React.Component {
      state = {};
      componentDidMount() {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'gives setState during reconciliation the same priority as whatever level is currently reconciling', () => {
    let instance;
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'updates triggered from inside a class setState updater', () => {
    let instance;
    class Foo extends React.Component {
      state = {};
      render() {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'getDerivedStateFromProps should update base state of updateQueue (based on product bug)', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'regression: does not expire soon due to layout effects in the last batch', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'regression: does not expire soon due to previous flushSync', () => {
    function Text({text}) {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'regression: does not expire soon due to previous expired work', () => {
    function Text({text}) {
      Scheduler.unstable_yieldValue(text);
      return text;
    }
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'when rebasing, does not exclude updates that were already committed, regardless of priority', async () => {
    const {useState, useLayoutEffect} = React;
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'when rebasing, does not exclude updates that were already committed, regardless of priority (classes)', async () => {
    let pushToLog;
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, "base state of update queue is initialized to its fiber's memoized state", async () => {
