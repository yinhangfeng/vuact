...
describe.skip('ReactIncrementalUpdatesMinimalism', () => {
  beforeEach(() => {
    jest.resetModules();
    React = require('react');
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should render a simple component', () => {
    function Child() {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should not diff referentially equal host elements', () => {
    function Leaf(props) {
      return (
        <span>
          hello
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should not diff parents of setState targets', () => {
    let childInst;
