...
describe('ReactIncremental', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should render a simple component, in steps if needed', () => {
    function Bar() {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'updates a previous render', () => {
    function Header() {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'can cancel partially rendered work and restart', () => {
    function Bar(props) {
      Scheduler.unstable_yieldValue('Bar');
      return <div>{props.children}</div>;
    }
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should call callbacks even if updates are aborted', () => {
    let inst;
  ...
  // @gate www
  it.skipIf(__VUACT_SKIP_TEST__, 'can deprioritize unfinished work and resume it later', () => {
    function Bar(props) {
      Scheduler.unstable_yieldValue('Bar');
      return <div>{props.children}</div>;
    }
  ...
  // @gate www
  it.skipIf(__VUACT_SKIP_TEST__, 'can deprioritize a tree from without dropping work', () => {
    function Bar(props) {
      Scheduler.unstable_yieldValue('Bar');
      return <div>{props.children}</div>;
    }
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'can use updater form of setState', () => {
    let instance;
    class Bar extends React.Component {
      constructor() {
        super();
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'can nest batchedUpdates', () => {
    let instance;
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'can handle if setState callback throws', () => {
    let instance;
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'merges and masks context', () => {
  ...
  // @gate www
  it.skipIf(__VUACT_SKIP_TEST__, 'provides context when reusing work', () => {
    class Intl extends React.Component {
      static childContextTypes = {
        locale: PropTypes.string,
      };
  ...
  it('reads context when setState is above the provider', () => {
    ...
    if (!__VUACT_SKIP_TEST__) {
      expect(Scheduler).toFlushAndYield([
        ...
        // XXX vuact 会跳过未依赖 context 组件的 render
        'IndirectionFn {}',
        'IndirectionClass {}',
  ...
  // TODO vuact2 context 会穿透 scu
  it.skipIf(__VUACT_SKIP_TEST__, 'should not update descendants with new context values if shouldComponentUpdate returns false', () => {
    let instance;
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should update descendants with new context values if setState() is called in the middle of the tree', () => {
    let middleInstance;
    let topInstance;
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'does not interrupt for update at same priority', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'does not interrupt for update at lower priority', () => {
    function Parent(props) {
      Scheduler.unstable_yieldValue('Parent: ' + props.step);
      return <Child step={props.step} />;
    }
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'does interrupt for update at higher priority', () => {
    function Parent(props) {
      Scheduler.unstable_yieldValue('Parent: ' + props.step);
      return <Child step={props.step} />;
    }
