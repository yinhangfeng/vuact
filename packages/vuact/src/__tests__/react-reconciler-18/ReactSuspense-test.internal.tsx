...
describe.skip('ReactSuspense', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'suspends rendering and continues later', () => {
    function Bar(props) {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'suspends siblings and later recovers each independently', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'interrupts current render if promise resolves before current render phase', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'throttles fallback committing globally', () => {
    function Foo() {
      Scheduler.unstable_yieldValue('Foo');
      return (
        <Suspense fallback={<Text text="Loading..." />}>
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'does not throttle fallback committing for too long', () => {
    function Foo() {
      Scheduler.unstable_yieldValue('Foo');
      return (
        <Suspense fallback={<Text text="Loading..." />}>
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'mounts a lazy class component in non-concurrent mode', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'updates memoized child of suspense component when context updates (simple memo)', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'updates memoized child of suspense component when context updates (manual memo)', () => {
    const {useContext, createContext, useState, memo} = React;
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'updates memoized child of suspense component when context updates (function)', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'updates memoized child of suspense component when context updates (forwardRef)', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 're-fires layout effects when re-showing Suspense', () => {
  ...
  describe.skipIf(__VUACT_SKIP_TEST2__, 'outside concurrent mode', () => {
    it.skipIf(__VUACT_SKIP_TEST2__, 'a mounted class component can suspend without losing state', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'bails out on timed-out primary children even if they receive an update', () => {
      let instance;
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'when updating a timed-out tree, always retries the suspended component', () => {
      let instance;
      class Stateful extends React.Component {
        state = {step: 1};
        render() {
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'suspends in a class that has componentWillUnmount and is then deleted', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'suspends in a component that also contains useEffect', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'retries when an update is scheduled on a timed out tree', () => {
      let instance;
      class Stateful extends React.Component {
        state = {step: 1};
        render() {
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'does not remount the fallback while suspended children resolve in legacy mode', () => {
      let mounts = 0;
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'does not get stuck with fallback in concurrent mode for a large delay', () => {
      function App(props) {
        return (
          <Suspense fallback={<Text text="Loading..." />}>
            <AsyncText ms={1000} text="Child 1" />
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'reuses effects, including deletions, from the suspended tree', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'does not warn if an mounted component is pinged', () => {
      const {useState} = React;
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'memoizes promise listeners per thread ID to prevent redundant renders', () => {
      function App() {
        return (
          <Suspense fallback={<Text text="Loading..." />}>
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, '#14162', () => {
      const {lazy} = React;
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'updates context consumer within child of suspended suspense component when context updates', () => {
