...
describe.skip('ReactIncrementalReflection', () => {
  beforeEach(() => {
    jest.resetModules();
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'handles isMounted even when the initial render is deferred', () => {
    const instances = [];
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'handles isMounted when an unmount is deferred', () => {
    const instances = [];
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'finds no node before insertion and correct node before deletion', () => {
