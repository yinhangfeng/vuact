...
describe('ReactDOMServerIntegrationUserInteraction', () => {
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'user interaction with controlled inputs', function() {
  ...
  describe('user interaction with inputs before client render', function() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should not blow away user-entered text on successful reconnect to an uncontrolled input', () =>
      testUserInteractionBeforeClientRender(<input defaultValue="Hello" />));

    it.skipIf(__VUACT_SKIP_TEST__, 'should not blow away user-entered text on successful reconnect to a controlled input', async () => {
      let changeCount = 0;
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should not blow away user-interaction on successful reconnect to an uncontrolled range input', () =>
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should not blow away user-interaction on successful reconnect to a controlled range input', async () => {
      let changeCount = 0;
      await testUserInteractionBeforeClientRender(
        <ControlledInput
          type="range"
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should not blow away user-entered text on successful reconnect to an uncontrolled checkbox', () =>
      testUserInteractionBeforeClientRender(
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should not blow away user-entered text on successful reconnect to a controlled checkbox', async () => {
      let changeCount = 0;
      await testUserInteractionBeforeClientRender(
        <ControlledCheckbox onChange={() => changeCount++} />,
        true,
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should not blow away user-selected value on successful reconnect to an uncontrolled select', () =>
      testUserInteractionBeforeClientRender(
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should not blow away user-selected value on successful reconnect to an controlled select', async () => {
      let changeCount = 0;
      await testUserInteractionBeforeClientRender(
        <ControlledSelect onChange={() => changeCount++} />,
      );
