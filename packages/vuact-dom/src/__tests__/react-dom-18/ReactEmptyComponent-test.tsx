...
describe('ReactEmptyComponent', () => {
  ...
  describe.each([null, undefined])('when %s', nullORUndefined => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should be able to switch between rendering nullish and a normal tag', () => {
      const instance1 = (
        <TogglingComponent
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should be able to switch in a list of children', () => {
      const instance1 = (
        <TogglingComponent
          firstComponent={nullORUndefined}
          secondComponent={'div'}
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'should distinguish between a script placeholder and an actual script tag', () => {
      const instance1 = (
        <TogglingComponent
          firstComponent={nullORUndefined}
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'can render nullish at the top level', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'preserves the dom node during updates', () => {
