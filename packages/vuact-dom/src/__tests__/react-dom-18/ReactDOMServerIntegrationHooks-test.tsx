...
describe.skip('ReactDOMServerHooks', () => {
  beforeEach(() => {
    resetModules();
  });
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'useReducer', () => {
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'useEffect', () => {
    const yields = [];
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'verifies yields in order', () => {
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'useCallback', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'renders successfully after a component using hooks throws an error', async () => {
    ...
    if (!__VUACT_SKIP_TEST__) {
      ...
      await ReactDOMServer.renderToString(<ThrowingComponent />);
    }
    ...
    container.innerHTML = await ReactDOMServer.renderToString(
