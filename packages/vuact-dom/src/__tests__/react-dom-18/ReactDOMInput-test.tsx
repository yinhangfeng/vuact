...
describe('ReactDOMInput', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should properly control a value even if no event listener exists', () => {
    let node;
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should control a value in reentrant events', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should control values in reentrant events with different targets', () => {
    class ControlledInputs extends React.Component {
      state = {value: 'lion'};
      a = null;
      b = null;
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'switching text inputs between numeric and string numbers', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'does change the string ".98" to "0.98" with no change handler', () => {
    class Stub extends React.Component {
      state = {
        value: '.98',
      };
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should update `defaultValue` for uncontrolled input', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should update `defaultValue` for uncontrolled date/time input', () => {
    const node = ReactDOM.render(
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should take `defaultValue` when changing to uncontrolled input', () => {
    const node = ReactDOM.render(
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should render defaultValue for SSR', async () => {
    const markup = await ReactDOMServer.renderToString(
  ...
  it('should render value for SSR', async () => {
    const element = <input type="text" value="1" onChange={() => {}} />;
    const markup = await ReactDOMServer.renderToString(element);
    const div = document.createElement('div');
    div.innerHTML = markup;
    expect(div.firstChild.getAttribute('value')).toBe('1');
    expect(div.firstChild.getAttribute('defaultValue')).toBe(null);
  ...
  it('should render name attribute if it is supplied for SSR', async () => {
  ...
  it('should not render name attribute if it is not supplied for SSR', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should throw for date inputs if `defaultValue` is an object where valueOf() throws', () => {
    class TemporalLike {
      valueOf() {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should throw for text inputs if `defaultValue` is an object where valueOf() throws', () => {
    class TemporalLike {
      valueOf() {
        // Throwing here is the behavior of ECMAScript "Temporal" date/time API.
        // See https://tc39.es/proposal-temporal/docs/plaindate.html#valueOf
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should throw for date inputs if `value` is an object where valueOf() throws', () => {
    class TemporalLike {
      valueOf() {
        // Throwing here is the behavior of ECMAScript "Temporal" date/time API.
        // See https://tc39.es/proposal-temporal/docs/plaindate.html#valueOf
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should throw for text inputs if `value` is an object where valueOf() throws', () => {
    class TemporalLike {
      valueOf() {
        // Throwing here is the behavior of ECMAScript "Temporal" date/time API.
        // See https://tc39.es/proposal-temporal/docs/plaindate.html#valueOf
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should properly control a value of number `0`', () => {
    const stub = <input type="text" value={0} onChange={emptyFunction} />;
    const node = ReactDOM.render(stub, container);
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should properly control 0.0 for a text input', () => {
    const stub = <input type="text" value={0} onChange={emptyFunction} />;
    const node = ReactDOM.render(stub, container);
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should properly control 0.0 for a number input', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should control radio buttons', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should check the correct radio when the selected name moves', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should control radio buttons if the tree updates during render', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should have a this value of undefined if bind is not used', () => {
    expect.assertions(1);
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'sets type, step, min, max before value always', () => {
    const log = [];
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'does not raise a validation warning when it switches types', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'resets value of date/time input to fix bugs in iOS Safari', () => {
    function strify(x) {
  ...
  describe('assigning the value attribute on controlled inputs', function() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'always sets the attribute when values change on text inputs', function() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'sets the value attribute on number inputs on blur', () => {
      const Input = getTestInput();
      const stub = ReactDOM.render(
        <Input type="number" value="1" />,
        container,
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'When given a Symbol value', function() {
    it.skipIf(__VUACT_SKIP_TEST__, 'treats initial Symbol value as an empty string', function() {
      expect(() =>
        ReactDOM.render(
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'treats updated Symbol value as an empty string', function() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'treats initial Symbol defaultValue as an empty string', function() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'treats updated Symbol defaultValue as an empty string', function() {
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'When given a function value', function() {
