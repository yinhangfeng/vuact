...
describe('ReactMultiChild', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should not warn for using generators in legacy iterables', () => {
    const fooIterable = {
      '@@iterator': function*() {
        yield (<h1 key="1">Hello</h1>);
        yield (<h1 key="2">World</h1>);
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should not warn for using generators in modern iterables', () => {
    const fooIterable = {
