...
describe('ReactCompositeComponent-state', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should support setting state', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should call componentDidUpdate of children first', async () => {
    const container = document.createElement('div');
    ...
    await nextTick();
    // TODO vuact 1. parent render 2. Intermediate scu false 不继续递归渲染 parent did update 3. child render child did update
  ...
  it('should merge state when sCU returns false', async function() {
    const log = [];
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should support setState in componentWillUnmount', () => {
    let subscription;
