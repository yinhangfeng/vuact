...
describe.skip('ReactDOMServerSelectiveHydration', () => {
  beforeEach(() => {
  ...
  describe('can handle replaying events as part of multiple instances of React', () => {
    ...
    beforeEach(async () => {
      ...
      const outerHTML = await ReactDOMServer.renderToString(<OuterApp />);
      ...
      const innerHTML = await ReactDOMServer.renderToString(<InnerApp />);
  ...
  it('hydrates before an update even if hydration moves away from it', async () => {
    ...
    const finalHTML = await ReactDOMServer.renderToString(<App a="A" />);
  ...
  it('fires capture event handlers and native events if content is hydratable during discrete event', async () => {
    ...
    let finalHTML;
    expect(async () => {
      finalHTML = await ReactDOMServer.renderToString(<App />);
    }).toErrorDev([
