...
function runActTests(label, render, unmount, rerender) {
  describe(label, () => {
    ...
    describe.skipIf(__VUACT_SKIP_TEST__, 'sync', () => {
      // @gate __DEV__
      ...
      describe.skipIf(__VUACT_SKIP_TEST__, 'fake timers', () => {
        beforeEach(() => {
          jest.useFakeTimers();
        });
    ...
    describe.skipIf(__VUACT_SKIP_TEST__, 'asynchronous tests', () => {
      // @gate __DEV__
    ...
    describe('error propagation', () => {
      ...
      // @gate __DEV__
      it.skipIf(__VUACT_SKIP_TEST__, 'should propagate errors from effects - sync', () => {
        function App() {
          React.useEffect(() => {
    ...
    describe.skipIf(__VUACT_SKIP_TEST__, 'suspense', () => {
    ...
    describe.skipIf(__VUACT_SKIP_TEST__, 'throw in prod mode', () => {
      // @gate !__DEV__
