...
describe('ReactDOMFiberAsync', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'flushSync flushes updates even if nested inside another flushSync', () => {
    const ops = [];
    let instance;
  ...
  describe('concurrent mode', () => {
    it.skipIf(__VUACT_SKIP_TEST__, 'does not perform deferred updates synchronously', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'top-level updates are concurrent', () => {
      const root = ReactDOMClient.createRoot(container);
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'deep updates (setState) are concurrent', () => {
      let instance;
      class Component extends React.Component {
        state = {step: 0};
        render() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'flushSync flushes updates before end of the tick', () => {
      const ops = [];
      let instance;
    ...
    // @gate www
    it.skipIf(__VUACT_SKIP_TEST__, 'flushControlled flushes updates before yielding to browser', () => {
      let inst;
      class Counter extends React.Component {
        state = {counter: 0};
        increment = () =>
    ...
    // @gate www
    it.skipIf(__VUACT_SKIP_TEST__, 'flushControlled does not flush until end of outermost batchedUpdates', () => {
      let inst;
      class Counter extends React.Component {
        state = {counter: 0};
        increment = () =>
    ...
    // @gate www
    it.skipIf(__VUACT_SKIP_TEST__, 'flushControlled returns nothing', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'regression test: does not drop passive effects across roots (#17066)', () => {
