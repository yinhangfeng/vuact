...
describe('ReactMultiChildText', () => {
  it.skipIf(__VUACT_SKIP_TEST2__, 'should correctly handle all possible children for render and update', () => {
    expect(() => {
      // prettier-ignore
      testAllPermutations([
        // basic values
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should throw if rendering both HTML and children', () => {
    expect(function() {
