...
describe('ReactErrorBoundaries', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'does not swallow exceptions on mounting without boundaries', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'does not swallow exceptions on updating without boundaries', () => {
    let container = document.createElement('div');
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'does not swallow exceptions on unmounting without boundaries', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'prevents errors from leaking into other roots', () => {
  ...
  it('logs a single error when using error boundary', () => {
    ...
    // TODO vuact3 error 之后仍旧会走完后续的生命周期
    if (!__VUACT_SKIP_TEST__) {
      expect(Scheduler).toHaveYielded([
        ...
        'ErrorBoundary static getDerivedStateFromError',
        // TODO vuact3 react 会两次 componentWillMount?
        'ErrorBoundary componentWillMount',
  ...
  if (!gate(flags => flags.disableModulePatternComponents)) {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'propagates errors on retry on mounting', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
        <RetryErrorBoundary>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'propagates errors inside boundary during componentWillMount', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'propagates errors inside boundary while rendering error state', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'does not call componentWillUnmount when aborting initial mount', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
        <Normal />
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'resets callback refs if mounting aborts', async () => {
    function childRef(x) {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'resets object refs if mounting aborts', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'catches if child throws in constructor during update', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
        <Normal />
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'catches if child throws in componentWillMount during update', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
        <Normal />
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'catches if child throws in componentWillReceiveProps during update', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
        <Normal />
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'catches if child throws in componentWillUpdate during update', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
        <Normal />
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'catches if child throws in render during update', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
        <Normal />
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'keeps refs up-to-date during updates', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'recovers from componentWillUnmount errors on update', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'recovers from nested componentWillUnmount errors on update', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
        <Normal>
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'picks the right boundary when handling unmounting errors', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'catches errors in componentDidMount', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
        <BrokenComponentWillUnmount>
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'catches errors in componentDidUpdate', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'catches errors in useEffect', () => {
    const container = document.createElement('div');
    act(() => {
      ReactDOM.render(
        <ErrorBoundary>
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'catches errors in useLayoutEffect', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'propagates errors inside boundary during componentDidMount', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'calls static getDerivedStateFromError for each error that is captured', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'discards a bad root if the root component fails', async () => {
    const X = null;
    const Y = undefined;
    let err1;
    let err2;
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'renders empty output if error boundary does not handle the error', () => {
    const container = document.createElement('div');
    expect(() =>
      ReactDOM.render(
        <div>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'passes first error when two errors happen in commit', () => {
    const errors = [];
    let caughtError;
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'propagates uncaught error inside unbatched initial mount', () => {
    function Foo() {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'handles errors that occur in before-mutation commit hook', () => {
    const errors = [];
    let caughtError;
    class Parent extends React.Component {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should call both componentDidCatch and getDerivedStateFromError if both exist on a component', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should catch errors from invariants in completion phase', async () => {
    const container = document.createElement('div');
    ReactDOM.render(
      <ErrorBoundary>
        <input>
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'catches errors thrown in componentWillUnmount', async () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'catches errors thrown while detaching refs', async () => {
    class LocalErrorBoundary extends React.Component {
      state = {error: null};
      static getDerivedStateFromError(error) {
        Scheduler.unstable_yieldValue(
