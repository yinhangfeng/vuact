...
describe('ReactComponentLifeCycle', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'throws when accessing state in componentWillMount', () => {
    class StatefulComponent extends React.Component {
  ...
  it('should call nested new lifecycle methods in the right order', () => {
    ...
    if (!__VUACT_SKIP_TEST__) {
      // TODO vuact1 由于 vue react commit 方式的不同，getSnapshotBeforeUpdate 的调用时机没法做到一致
      expect(log).toEqual([
        'outer getDerivedStateFromProps',
        'outer shouldComponentUpdate',
        'inner getDerivedStateFromProps',
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should invoke both deprecated and new lifecycles if both are present', () => {
    const log = [];
...
Please update the following components: MyComponent`,
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'react-lifecycles-compat', () => {
