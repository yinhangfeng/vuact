...
describe('ReactDOMSelect', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should allow setting `defaultValue`', () => {
    const stub = (
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should not control when using `defaultValue`', () => {
    const el = (
      <select defaultValue="giraffe">
        <option value="monkey">A monkey!</option>
        <option value="giraffe">A giraffe!</option>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should allow setting `defaultValue` with multiple', () => {
    const stub = (
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should allow setting `value` with multiple', () => {
    const stub = (
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should allow setting `value` to __proto__ with multiple', () => {
    const stub = (
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should not select other options automatically', () => {
    const stub = (
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should reset child options selected when they are changed and `value` is set', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should allow setting `value` with `objectToString`', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should allow switching to multiple', () => {
    const stub = (
      <select defaultValue="giraffe">
        <option value="monkey">A monkey!</option>
        <option value="giraffe">A giraffe!</option>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should allow switching from multiple', () => {
    const stub = (
      <select multiple={true} defaultValue={['giraffe', 'gorilla']}>
        <option value="monkey">A monkey!</option>
        <option value="giraffe">A giraffe!</option>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'does not select an item when size is initially set to greater than 1', () => {
    const stub = (
      <select size="2">
        <option value="monkey">A monkey!</option>
        <option value="giraffe">A giraffe!</option>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should remember value when switching to uncontrolled', () => {
    const stub = (
      <select value={'giraffe'} onChange={noop}>
        <option value="monkey">A monkey!</option>
        <option value="giraffe">A giraffe!</option>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should remember updated value when switching to uncontrolled', () => {
    const stub = (
      <select value={'giraffe'} onChange={noop}>
        <option value="monkey">A monkey!</option>
        <option value="giraffe">A giraffe!</option>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should support server-side rendering', async () => {
    const stub = (
      <select value="giraffe" onChange={noop}>
        <option value="monkey">A monkey!</option>
        <option value="giraffe">A giraffe!</option>
    ...
    const container = document.createElement('div');
    container.innerHTML = await ReactDOMServer.renderToString(stub);
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should support server-side rendering with defaultValue', async () => {
    const stub = (
      <select defaultValue="giraffe">
        <option value="monkey">A monkey!</option>
        <option value="giraffe">A giraffe!</option>
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should support server-side rendering with dangerouslySetInnerHTML', async () => {
    const stub = (
      <select defaultValue="giraffe">
        <option
          value="monkey"
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should support server-side rendering with multiple', async () => {
    const stub = (
      <select multiple={true} value={['giraffe', 'gorilla']} onChange={noop}>
        <option value="monkey">A monkey!</option>
        <option value="giraffe">A giraffe!</option>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should not control defaultValue if re-adding options', () => {
    const container = document.createElement('div');
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should warn if value is null', () => {
    expect(() =>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should refresh state on change', () => {
    const stub = (
      <select value="giraffe" onChange={noop}>
        <option value="monkey">A monkey!</option>
        <option value="giraffe">A giraffe!</option>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should warn if value and defaultValue props are specified', () => {
    expect(() =>
      ReactTestUtils.renderIntoDocument(
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should not warn about missing onChange in uncontrolled textareas', () => {
    const container = document.createElement('div');
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should be able to safely remove select onChange', () => {
    function changeView() {
      ReactDOM.unmountComponentAtNode(container);
    }
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should select grandchild options nested inside an optgroup', () => {
    const stub = (
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should allow controlling `value` in a nested render', () => {
    let selectNode;
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should not select first option by default when multiple is set and no defaultValue is set', () => {
    const stub = (
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'When given a Symbol value', () => {
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'When given a function value', () => {
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'When given a Temporal.PlainDate-like value', () => {
    class TemporalLike {
      valueOf() {
