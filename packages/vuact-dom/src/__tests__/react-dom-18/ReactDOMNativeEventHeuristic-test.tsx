...
describe('ReactDOMNativeEventHeuristic-test', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'mouse over should be user-blocking but not discrete', async () => {
    const root = ReactDOMClient.createRoot(container);
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'mouse enter should be user-blocking but not discrete', async () => {
    const root = ReactDOMClient.createRoot(container);
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'continuous native events flush as expected', async () => {
    const root = ReactDOMClient.createRoot(container);
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should not flush discrete events at the end of outermost batchedUpdates', async () => {
    const root = ReactDOMClient.createRoot(container);
