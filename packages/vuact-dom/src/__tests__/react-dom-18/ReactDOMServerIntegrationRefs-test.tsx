...
describe('ReactDOMServerIntegration', () => {
  ...
  describe('refs', function() {
    ...
    it.skipIf(__VUACT_SKIP_TEST2__, 'should have string refs on client when rendered over server markup', async () => {
      class RefsComponent extends React.Component {
        render() {
      ...
      const markup = await ReactDOMServer.renderToString(<RefsComponent />);
