...
describe('ReactDOM unknown attribute', () => {
  ...
  describe('unknown attributes', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'changes values true, false to null, and also warns once', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'throws with Temporal-like objects', () => {
      class TemporalLike {
        valueOf() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'removes symbols and warns', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'removes functions and warns', () => {
      expect(() =>
