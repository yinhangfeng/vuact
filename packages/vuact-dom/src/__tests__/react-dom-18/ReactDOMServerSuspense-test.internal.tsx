...
describe('ReactDOMServerSuspense', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should render the fallback when a promise thrown', async () => {
    const c = await serverRender(
      <div>
        <React.Suspense fallback={<Text text="Fallback" />}>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should work with nested suspense components', async () => {
    const c = await serverRender(
      <div>
        <React.Suspense fallback={<Text text="Fallback" />}>
          <div>
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'does not get confused by throwing null', async () => {
    function Bad() {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'does not get confused by throwing undefined', async () => {
    function Bad() {
      // eslint-disable-next-line no-throw-literal
      throw undefined;
    }
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'does not get confused by throwing a primitive', async () => {
    function Bad() {
      // eslint-disable-next-line no-throw-literal
      throw 'foo';
    }
