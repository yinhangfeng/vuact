...
describe.skip('ReactDOMServerHydration', () => {
  beforeEach(() => {
    jest.resetModules();
    React = require('react');
  ...
  it('should have the correct mounting behavior (new hydrate API)', async () => {
    ...
    try {
      ...
      lastMarkup = await ReactDOMServer.renderToString(<TestComponent name="x" />);
  ...
  it('should emit autofocus on the server but not focus() when hydrating', async () => {
    const element = document.createElement('div');
    element.innerHTML = await ReactDOMServer.renderToString(
  ...
  it('should throw rendering portals on the server', async () => {
  ...
  it('should be able to render and hydrate Mode components', async () => {
    ...
    const element = document.createElement('div');
    expect(async () => {
      element.innerHTML = await ReactDOMServer.renderToString(markup);
  ...
  it('should be able to use lazy components after hydrating', async () => {
    ...
    const element = document.createElement('div');
    element.innerHTML = await ReactDOMServer.renderToString(<HelloWorld />);
  ...
  it('does not re-enter hydration after committing the first one', async () => {
    const finalHTML = await ReactDOMServer.renderToString(<div />);
  ...
  it('should warn when hydrating read-only properties', async () => {
    ...
    for (const readOnlyProperty of readOnlyProperties) {
      ...
      const element = document.createElement('div');
      element.innerHTML = await ReactDOMServer.renderToString(jsx);
  ...
  it('should not re-assign properties on hydration', async () => {
    ...
    container.innerHTML = await ReactDOMServer.renderToString(jsx);
