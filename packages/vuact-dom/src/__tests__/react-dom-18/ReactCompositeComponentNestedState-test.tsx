...
describe.skip('ReactCompositeComponentNestedState-state', () => {
  beforeEach(() => {
    React = require('react');
    ReactDOM = require('react-dom');
  });

  it.skipIf(__VUACT_SKIP_TEST__, 'should provide up to date values for props', async () => {
      ...
      handleHue = (shade, color) => {
        ...
        this.setState(
          function(state, props) {
            ...
            // TODO vuact1 异步问题 onSelectColor 还未生效，props.color 是旧的
