...
describe.skipIf(__VUACT_SKIP_TEST2__, 'reactiverefs', () => {
  let container;
   ...
   */
  it.skipIf(__VUACT_SKIP_TEST2__, 'Should increase refs with an increase in divs', () => {
...
describe('ref swapping', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'Allow refs to hop around children correctly', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'coerces numbers to strings', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'provides an error for invalid refs', () => {
    expect(() => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should warn about callback refs returning a function', () => {
...
describe.skipIf(__VUACT_SKIP_TEST2__, 'root level refs', () => {
  it.skipIf(__VUACT_SKIP_TEST2__, 'attaches and detaches root refs', () => {
    let inst = null;
...
describe.skipIf(__VUACT_SKIP_TEST2__, 'creating element with string ref in constructor', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'throws an error', () => {
    ReactTestUtils = require('react-dom/test-utils');
...
describe.skipIf(__VUACT_SKIP_TEST2__, 'strings refs across renderers', () => {
  it.skipIf(__VUACT_SKIP_TEST2__, 'does not break', () => {
