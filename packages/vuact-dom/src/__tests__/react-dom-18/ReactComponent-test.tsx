...
describe('ReactComponent', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should throw on invalid render targets', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should throw when supplying a string ref outside of render method', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should support string refs on owned components', () => {
    const innerObj = {};
    const outerObj = {};
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'should call refs at the correct time', () => {
    const log = [];
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'throws usefully when rendering badly-typed elements', () => {
    const X = undefined;
    expect(() => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'includes owner name in the error about badly-typed elements', () => {
    const X = undefined;
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'throws if a plain object is used as a child', () => {
    const children = {
      x: <span />,
      y: <span />,
      z: <span />,
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'throws if a plain object even if it is in an owner', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'throws if a plain object is used as a child when using SSR', async () => {
    const children = {
      x: <span />,
      y: <span />,
      z: <span />,
    ...
    const element = <div>{[children]}</div>;
    expect(async () => {
      await ReactDOMServer.renderToString(element);
    }).toThrowError(
      'Objects are not valid as a React child (found: object with keys {x, y, z}). ' +
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'throws if a plain object even if it is in an owner when using SSR', async () => {
    class Foo extends React.Component {
      render() {
        const children = {
          a: <span />,
    ...
    const container = document.createElement('div');
    expect( async () => {
      await ReactDOMServer.renderToString(<Foo />, container);
    }).toThrowError(
      'Objects are not valid as a React child (found: object with keys {a, b, c}). ' +
        'If you meant to render a collection of children, use ' +
        'an array instead.',
