...
describe('ReactMultiChildReconcile', () => {
   ...
   */
  it.skipIf(__VUACT_SKIP_TEST2__, 'should remove nulled out children at the beginning', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should remove nulled out children at the end', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should reverse the order of two children', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should reverse the order of more than two children', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          userOne: 'userOneStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should cycle order correctly', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          userOne: 'userOneStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should cycle order correctly in the other direction', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          userOne: 'userOneStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should remove nulled out children and ignore new null children', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should remove nulled out children and reorder remaining', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should append children to the end', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should append multiple children to the end', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should prepend children to the beginning', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should prepend multiple children to the beginning', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should not prepend an empty child to the beginning', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should not append an empty child to the end', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should not insert empty children in the middle', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should insert one new child in the middle', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should insert multiple new truthy children in the middle', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
  ...
  it.skipIf(__VUACT_SKIP_TEST2__, 'should insert non-empty children in middle where nulls were', () => {
    const PROPS_SEQUENCE = [
      {
        usernameToStatus: {
          jcw: 'jcwStatus',
