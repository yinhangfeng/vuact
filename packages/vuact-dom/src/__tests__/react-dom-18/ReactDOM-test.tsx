...
describe('ReactDOM', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'throws in render() if the mount callback is not a function', () => {
    function Foo() {
      this.a = 1;
      this.b = 2;
    }
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'throws in render() if the update callback is not a function', () => {
    function Foo() {
      this.a = 1;
      this.b = 2;
    }
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'preserves focus', () => {
    let input;
    let input2;
    class A extends React.Component {
      render() {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'calls focus() on autoFocus elements after they have been mounted to the DOM', () => {
