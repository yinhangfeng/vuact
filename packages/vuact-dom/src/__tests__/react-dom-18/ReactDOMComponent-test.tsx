...
describe('ReactDOMComponent', () => {
  ...
  describe('updateDOM', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should warn for unknown string event handlers', () => {
      const container = document.createElement('div');
      expect(() =>
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should warn for unknown function event handlers', () => {
      const container = document.createElement('div');
      expect(() =>
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'throws with Temporal-like objects as style values', () => {
      class TemporalLike {
        valueOf() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should skip reserved props on web components', () => {
      const container = document.createElement('div');
    ...
    if (ReactFeatureFlags.enableFilterEmptyStringAttributesDOM) {
      it.skipIf(__VUACT_SKIP_TEST__, 'should not add an empty src attribute', () => {
        const container = document.createElement('div');
      ...
      it.skipIf(__VUACT_SKIP_TEST__, 'should not add an empty href attribute', () => {
        const container = document.createElement('div');
      ...
      it.skipIf(__VUACT_SKIP_TEST__, 'should not add an empty action attribute', () => {
        const container = document.createElement('div');
      ...
      it.skipIf(__VUACT_SKIP_TEST__, 'should not add an empty formAction attribute', () => {
        const container = document.createElement('div');
        expect(() =>
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should apply React-specific aliases to HTML elements', () => {
      const container = document.createElement('div');
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should apply React-specific aliases to SVG elements', () => {
      const container = document.createElement('div');
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should not apply React-specific aliases to custom elements', () => {
      const container = document.createElement('div');
      ReactDOM.render(<some-custom-element arabicForm="foo" />, container);
      const node = container.firstChild;
      // Should not get transformed to arabic-form as SVG would be.
      // TODO vuact3 getAttributeAlias 需要判断一下
    ...
    it('should reject attribute key injection attack on markup for regular DOM (SSR)', () => {
      expect( async () => {
        for (let i = 0; i < 3; i++) {
          ...
          const result1 = await ReactDOMServer.renderToString(element1);
          const result2 = await ReactDOMServer.renderToString(element2);
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should reject attribute key injection attack on mount for regular DOM', () => {
      expect(() => {
        for (let i = 0; i < 3; i++) {
          const container = document.createElement('div');
          ReactDOM.render(
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should reject attribute key injection attack on mount for custom elements', () => {
      expect(() => {
        for (let i = 0; i < 3; i++) {
          const container = document.createElement('div');
          ReactDOM.render(
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should reject attribute key injection attack on update for regular DOM', () => {
      expect(() => {
        for (let i = 0; i < 3; i++) {
          const container = document.createElement('div');
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should reject attribute key injection attack on update for custom elements', () => {
      expect(() => {
        for (let i = 0; i < 3; i++) {
          const container = document.createElement('div');
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should not incur unnecessary DOM mutations for attributes', () => {
      const container = document.createElement('div');
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should not incur unnecessary DOM mutations for string properties', () => {
      const container = document.createElement('div');
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should not update when switching between null/undefined', () => {
      const container = document.createElement('div');
      const node = ReactDOM.render(<div />, container);

      const setter = jest.fn();
      // TODO vuact1 vue 不调用 setAttribute? 参考 vue shouldSetAsProp
  ...
  describe('createOpenTagMarkup', () => {
    ...
    it('should generate the correct markup with className', async () => {
      expectToHaveAttribute(await genMarkup({className: 'a'}), ['class', 'a']);
      expectToHaveAttribute(await genMarkup({className: 'a b'}), ['class', 'a b']);
      expectToHaveAttribute(await genMarkup({className: ''}), ['class', '']);
    });

    it.skipIf(__VUACT_SKIP_TEST__, 'should escape style names and values', async () => {
  ...
  describe('createContentMarkup', () => {
    ...
    it('should handle dangerouslySetInnerHTML', async () => {
      ...
      expect(
        toHaveInnerhtml(
          await genMarkup({dangerouslySetInnerHTML: innerHTML}),
          'testContent',
        ),
      ).toBe(true);
    });
  ...
  describe('mountComponent', () => {
    ...
    it('should warn for uppercased selfclosing tags', async () => {
      ...
      if (__VUACT_SKIP_TEST__) {
        returnedValue = await ReactDOMServer.renderToString(<Container />);
      } else {
        expect(() => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should throw on children for void elements', () => {
      const container = document.createElement('div');
      expect(() => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should throw on dangerouslySetInnerHTML for void elements', () => {
      const container = document.createElement('div');
      expect(() => {
        ReactDOM.render(
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should treat menuitem as a void element but still create the closing tag', async () => {
      // menuitem is not implemented in jsdom, so this triggers the unknown warning error
      const container = document.createElement('div');

      const returnedValue = await ReactDOMServer.renderToString(
        <menu>
          <menuitem />
        </menu>,
      );
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should validate against multiple children props', () => {
      expect(function() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should validate use of dangerouslySetInnerHTML', () => {
      expect(function() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should validate against invalid styles', () => {
      expect(function() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should throw for children on void elements', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should support custom elements which extend native elements', () => {
      const container = document.createElement('div');
  ...
  describe('updateComponent', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should warn against children for void elements', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should warn against dangerouslySetInnerHTML for void elements', () => {
      ReactDOM.render(<input />, container);
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should report component containing invalid styles', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should properly escape text content and attributes values', () => {
      expect(
  ...
  describe('tag sanitization', () => {
    it.skipIf(__VUACT_SKIP_TEST__, 'should throw when an invalid tag name is used server-side', async () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should throw when an attack vector is used server-side', () => {
  ...
  describe('nesting validation', () => {
    ...
    it('should warn about incorrect casing on properties (ssr)', async () => {
      expect(async () => {
    ...
    it('should warn about incorrect casing on event handlers (ssr)', async () => {
      expect(async () => {
        await ReactDOMServer.renderToString(
    ...
    it('should warn about props that are no longer supported (ssr)', async () => {
      await ReactDOMServer.renderToString(<div />);
      expect(() =>
    ...
    it('should warn about props that are no longer supported without case sensitivity (ssr)', async () => {
      await ReactDOMServer.renderToString(<div />);
      expect(() =>
        ReactDOMServer.renderToString(<div onfocusin={() => {}} />),
      ).toErrorDev(
  ...
  describe('Custom attributes', function() {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'does not assign a boolean custom attributes as a string', function() {
      let el;
      expect(() => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'does not assign an implicit boolean custom attributes', function() {
      let el;
      expect(() => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'will not assign a function custom attributes', function() {
      let el;
      expect(() => {
        el = ReactTestUtils.renderIntoDocument(<div whatever={() => {}} />);
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'removes a property when it becomes invalid', function() {
      const container = document.createElement('div');
  ...
  describe('Object stringification', function() {
    it.skipIf(__VUACT_SKIP_TEST__, 'allows objects on known properties', function() {
      const el = ReactTestUtils.renderIntoDocument(<div acceptCharset={{}} />);
      expect(el.getAttribute('accept-charset')).toBe('[object Object]');
    });

    it.skipIf(__VUACT_SKIP_TEST__, 'should pass objects as attributes if they define toString', () => {
      const obj = {
        toString() {
          return 'hello';
        },
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'passes objects on known SVG attributes if they do not define toString', () => {
      const obj = {};
      const container = document.createElement('div');
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'allows objects that inherit a custom toString method', function() {
  ...
  describe('String boolean attributes', function() {
    it.skipIf(__VUACT_SKIP_TEST__, 'does not assign string boolean attributes for custom attributes', function() {
      let el;
      expect(() => {
        el = ReactTestUtils.renderIntoDocument(<div whatever={true} />);
      }).toErrorDev(
  ...
  describe.skipIf(__VUACT_SKIP_TEST__, 'Hyphenated SVG elements', function() {
    it.skipIf(__VUACT_SKIP_TEST__, 'the font-face element is not a custom element', function() {
      let el;
      expect(() => {
        el = ReactTestUtils.renderIntoDocument(
          <svg>
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'the font-face element does not allow unknown boolean values', function() {
      let el;
      expect(() => {
        el = ReactTestUtils.renderIntoDocument(
          <svg>
  ...
  describe('iOS Tap Highlight', () => {
    it.skipIf(__VUACT_SKIP_TEST__, 'adds onclick handler to elements with onClick prop', () => {
      const container = document.createElement('div');
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'adds onclick handler to a portal root', () => {
      const container = document.createElement('div');
