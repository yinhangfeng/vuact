...
describe.skip('ReactDOMServer', () => {
  ...
  describe('renderToString', async () => {
    it('should generate simple markup', async () => {
      const response = await ReactDOMServer.renderToString(<span>hello world</span>);
      expect(response).toMatch(new RegExp('<span' + '>hello world</span>'));
    });

    it('should generate simple markup for self-closing tags', async () => {
      const response = await ReactDOMServer.renderToString(<img />);
    ...
    it('should generate comment markup for component returns null', async () => {
      ...
      const response = await ReactDOMServer.renderToString(<NullComponent />);
    ...
    it('should render composite components', async () => {
      ...
      const response = await ReactDOMServer.renderToString(<Parent />);
    ...
    it('should only execute certain lifecycle methods', async () => {
      async function runTest() {
        ...
        const response = await ReactDOMServer.renderToString(<TestComponent />);
    ...
    it('should throw prop mapping error for an <iframe /> with invalid props', async () => {
      expect(async () => {
        await ReactDOMServer.renderToString(<iframe style="border:none;" />);
      }).toThrowError(
  ...
  it('warns with a no-op when an async setState is triggered', async () => {
    ...
    await ReactDOMServer.renderToString(<Foo />);
    expect(() =>
  ...
  it('warns with a no-op when an async forceUpdate is triggered', async () => {
    ...
    await ReactDOMServer.renderToString(<Baz />);
    expect(() =>
      jest.runOnlyPendingTimers(),
    ).toErrorDev(
  ...
  it('does not get confused by throwing null', async () => {
    function Bad() {
    ...
    let error;
    try {
      await ReactDOMServer.renderToString(<Bad />);
    } catch (err) {
      didError = true;
      error = err;
    }
  ...
  it('does not get confused by throwing undefined', async () => {
    function Bad() {
      // eslint-disable-next-line no-throw-literal
      throw undefined;
    }
  ...
  it('does not get confused by throwing a primitive', async () => {
    function Bad() {
      // eslint-disable-next-line no-throw-literal
      throw 'foo';
    }
  ...
  it('should warn if an invalid contextType is defined', async () => {
    ...
    expect(async () => {
      await ReactDOMServer.renderToString(<ComponentA />);
    }).toErrorDev(
    ...
    expect(async () => {
      await ReactDOMServer.renderToString(<ComponentB />);
    }).toErrorDev(
  ...
  describe('custom element server rendering', () => {
    it('String properties should be server rendered for custom elements', async () => {
      const output = await ReactDOMServer.renderToString(
        <my-custom-element foo="bar" />,
      );
      expect(output).toBe(`<my-custom-element foo="bar"></my-custom-element>`);
    });

    it('Number properties should be server rendered for custom elements', async () => {
      const output = await ReactDOMServer.renderToString(
    ...
    it('Object properties should not be server rendered for custom elements', async () => {
      const output = await ReactDOMServer.renderToString(
    ...
    // @gate enableCustomElementPropertySupport
    it('Array properties should not be server rendered for custom elements', async () => {
      const output = await ReactDOMServer.renderToString(
        <my-custom-element foo={['foo', 'bar']} />,
      );
      expect(output).toBe(`<my-custom-element></my-custom-element>`);
    ...
    it('Function properties should not be server rendered for custom elements', async () => {
      const output = await ReactDOMServer.renderToString(
