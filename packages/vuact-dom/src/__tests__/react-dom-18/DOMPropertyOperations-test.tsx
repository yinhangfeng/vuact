...
describe('DOMPropertyOperations', () => {
  ...
  describe('setValueForProperty', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__)('should set values as attributes if necessary', () => {
      const container = document.createElement('div');
    ...
    it.skipIf(__VUACT_SKIP_TEST__).skip('should set values as namespace attributes if necessary', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__)('should set values as boolean properties', () => {
      const container = document.createElement('div');
    ...
    it.skipIf(__VUACT_SKIP_TEST__)('should convert attribute values to string first', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__)('should remove for falsey boolean properties', () => {
      const container = document.createElement('div');
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should set className to empty string instead of null', () => {
      const container = document.createElement('div');
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should always assign the value attribute for non-inputs', function() {
      const container = document.createElement('div');
    ...
    it('custom element custom events lowercase', () => {
      ...
      function Test() {
        // TODO vuact2 oncustomevent => onCustomevent
    ...
    // @gate enableCustomElementPropertySupport
    it.skipIf(__VUACT_SKIP_TEST__)('custom element custom events uppercase', () => {
      const oncustomevent = jest.fn();
      function Test() {
        return <my-custom-element onCustomevent={oncustomevent} />;
      }
    ...
    it('custom elements should still have onClick treated like regular elements', () => {
      ...
      if (!__VUACT_SKIP_TEST2__) expect(syntheticClickEvent.nativeEvent).toBe(nativeClickEvent);
    });
    ...
    it.skipIf(__VUACT_SKIP_TEST__, '<input is=...> should have the same onChange/onInput/onClick behavior as <input>', () => {
      const container = document.createElement('div');
      document.body.appendChild(container);
    ...
    it.skipIf(__VUACT_SKIP_TEST__, '<input type=radio is=...> should have the same onChange/onInput/onClick behavior as <input type=radio>', () => {
      const container = document.createElement('div');
      document.body.appendChild(container);
      const regularOnInputHandler = jest.fn();
      const regularOnChangeHandler = jest.fn();
    ...
    it.skipIf(__VUACT_SKIP_TEST__, '<select is=...> should have the same onChange/onInput/onClick behavior as <select>', () => {
      const container = document.createElement('div');
      document.body.appendChild(container);
      const regularOnInputHandler = jest.fn();
      const regularOnChangeHandler = jest.fn();
    ...
    // @gate enableCustomElementPropertySupport
    it.skipIf(__VUACT_SKIP_TEST__, 'onChange/onInput/onClick on div with various types of children', () => {
      const container = document.createElement('div');
      document.body.appendChild(container);
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'custom element onChange/onInput/onClick with event target input child', () => {
      const container = document.createElement('div');
      document.body.appendChild(container);
      const onChangeHandler = jest.fn();
      const onInputHandler = jest.fn();
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'custom element onChange/onInput/onClick with event target div child', () => {
      const container = document.createElement('div');
      document.body.appendChild(container);
      const onChangeHandler = jest.fn();
      const onInputHandler = jest.fn();
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'div onChange/onInput/onClick with event target div child', () => {
      const container = document.createElement('div');
      document.body.appendChild(container);
      const onChangeHandler = jest.fn();
      const onInputHandler = jest.fn();
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'innerHTML should not work on custom elements', () => {
      const container = document.createElement('div');
    ...
    // @gate enableCustomElementPropertySupport
    it.skipIf(__VUACT_SKIP_TEST__, 'innerText should not work on custom elements', () => {
      const container = document.createElement('div');
    ...
    // @gate enableCustomElementPropertySupport
    it.skipIf(__VUACT_SKIP_TEST__, 'textContent should not work on custom elements', () => {
      const container = document.createElement('div');
    ...
    // @gate enableCustomElementPropertySupport
    it.skipIf(__VUACT_SKIP_TEST__, 'values should not be converted to booleans when assigning into custom elements', () => {
      const container = document.createElement('div');
      document.body.appendChild(container);
      ReactDOM.render(<my-custom-element />, container);
      const customElement = container.querySelector('my-custom-element');
    ...
    // @gate enableCustomElementPropertySupport
    it.skipIf(__VUACT_SKIP_TEST__, 'boolean props should not be stringified in attributes', () => {
      const container = document.createElement('div');
      document.body.appendChild(container);
      ReactDOM.render(<my-custom-element foo={true} />, container);
      const customElement = container.querySelector('my-custom-element');
    ...
    // @gate enableCustomElementPropertySupport
    it.skipIf(__VUACT_SKIP_TEST__, 'custom element custom event handlers assign multiple types', () => {
      const container = document.createElement('div');
      document.body.appendChild(container);
      const oncustomevent = jest.fn();
    ...
    // @gate enableCustomElementPropertySupport
    it.skipIf(__VUACT_SKIP_TEST__, 'custom element custom event handlers assign multiple types with setter', () => {
      const container = document.createElement('div');
      document.body.appendChild(container);
      const oncustomevent = jest.fn();
  ...
  describe('deleteValueForProperty', () => {
    ...
    it.skipIf(__VUACT_SKIP_TEST__, 'should not remove attributes for special properties', () => {
      const container = document.createElement('div');
      ReactDOM.render(
