...
describe('ReactDOMRoot', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'throws a good message on invalid containers', () => {
    expect(() => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'warns when unmounting with legacy API (no previous content)', () => {
    const root = ReactDOMClient.createRoot(container);
    root.render(<div>Hi</div>);
    Scheduler.unstable_flushAll();
    expect(container.textContent).toEqual('Hi');
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'warns when unmounting with legacy API (has previous content)', () => {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'opts-in to concurrent default updates', async () => {
    const root = ReactDOMClient.createRoot(container, {
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'throws if an unmounted root is updated', async () => {
    const root = ReactDOMClient.createRoot(container);
    await act(async () => {
      root.render('Hi');
    });
  ...
  it.skipIf(__VUACT_SKIP_TEST__, 'errors if container is a comment node', () => {
